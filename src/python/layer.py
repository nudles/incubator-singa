...
class Layer(object):
    ...
    def get_params(self):
        return self.layer.param_values()
...
class Conv1D(Conv2D):
    ...
    def __init__(self, name, nb_kernels, kernel=3, stride=1,
        ...
        super(Conv1D, self).__init__(nb_kernels, (1, kernel), (0, stride),
...
class MaxPooling2D(Pooling2D):
    ...
    def __init__(self, name, kernel=3, stride=2, border_mode='same', pad=None,
        ...
        super(MaxPooling2D, self).__init__(model_pb2.PoolingConf.MAX,
...
class AvgPooling2D(Pooling2D):
    ...
    def __init__(self, name, kernel=3, stride=2, border_mode='same', pad=None,
                 data_format='NCHW', engine='cudnn', input_sample_shape=None):
        super(AvgPooling2D, self).__init__(model_pb2.PoolingConf.AVE,
                                           kernel, stride, border_mode,
                                           pad, data_format, engine, name,
                                           input_sample_shape)
...
class MaxPooling1D(MaxPooling2D):
    ...
    def __init__(self, name, kernel=3, stride=2, border_mode='same', pad=None,
        ...
        if input_sample_shape is not None:
            ...
            input_sample_shape = None
        super(MaxPooling1D, self).__init__((1, kernel), (0, stride),
                                           border_mode, pad,
...
class AvgPooling1D(AvgPooling2D):
    ...
    def __init__(self, name, kernel=3, stride=2, border_mode='same', pad=None,
        ...
        super(AvgPooling1D, self).__init__((kernel, 1), (0, stride),
                                           border_mode, pad2,
                                           data_format, engine, name,
                                           input_sample_shape)
...
class BatchNormalization(Layer):
    ...
    def __init__(self, name, momentum=0.9, engine='cudnn',
                 beta_specs={'init': 'Xavier'}, gamma_specs={'init': 'Xavier'},
                 input_sample_shape=None):
        """Batch-normalization.
...
class Dense(Layer):
    ...
    def __init__(self, name, num_output, use_bias=True,
                 W_specs={'init': 'Xavier'}, b_specs={'init': 'Xavier'},
...
class Dropout(Layer):
    ...
    def __init__(self, name, p=0.5, engine='cudnn', input_sample_shape=None):
        """Droput layer.
...
def get_layer_list():
    ...
    return singa.GetRegisteredLayers()
