...
class paramVector(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, paramVector, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, paramVector, name)
    __repr__ = _swig_repr
    def iterator(self): return _driver.paramVector_iterator(self)
    def __iter__(self): return self.iterator()
    def __nonzero__(self): return _driver.paramVector___nonzero__(self)
    def __bool__(self): return _driver.paramVector___bool__(self)
    def __len__(self): return _driver.paramVector___len__(self)
    def pop(self): return _driver.paramVector_pop(self)
    def __getslice__(self, *args): return _driver.paramVector___getslice__(self, *args)
    def __setslice__(self, *args): return _driver.paramVector___setslice__(self, *args)
    def __delslice__(self, *args): return _driver.paramVector___delslice__(self, *args)
    def __delitem__(self, *args): return _driver.paramVector___delitem__(self, *args)
    def __getitem__(self, *args): return _driver.paramVector___getitem__(self, *args)
    def __setitem__(self, *args): return _driver.paramVector___setitem__(self, *args)
    def append(self, *args): return _driver.paramVector_append(self, *args)
    def empty(self): return _driver.paramVector_empty(self)
    def size(self): return _driver.paramVector_size(self)
    def clear(self): return _driver.paramVector_clear(self)
    def swap(self, *args): return _driver.paramVector_swap(self, *args)
    def get_allocator(self): return _driver.paramVector_get_allocator(self)
    def begin(self): return _driver.paramVector_begin(self)
    def end(self): return _driver.paramVector_end(self)
    def rbegin(self): return _driver.paramVector_rbegin(self)
    def rend(self): return _driver.paramVector_rend(self)
    def pop_back(self): return _driver.paramVector_pop_back(self)
    def erase(self, *args): return _driver.paramVector_erase(self, *args)
    def __init__(self, *args): 
        this = _driver.new_paramVector(*args)
        try: self.this.append(this)
        except: self.this = this
    def push_back(self, *args): return _driver.paramVector_push_back(self, *args)
    def front(self): return _driver.paramVector_front(self)
    def back(self): return _driver.paramVector_back(self)
    def assign(self, *args): return _driver.paramVector_assign(self, *args)
    def resize(self, *args): return _driver.paramVector_resize(self, *args)
    def insert(self, *args): return _driver.paramVector_insert(self, *args)
    def reserve(self, *args): return _driver.paramVector_reserve(self, *args)
    def capacity(self): return _driver.paramVector_capacity(self)
    __swig_destroy__ = _driver.delete_paramVector
    __del__ = lambda self : None;
paramVector_swigregister = _driver.paramVector_swigregister
paramVector_swigregister(paramVector)
...
class NeuralNet(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["CreateFromStr"] = lambda x: _driver.NeuralNet_CreateFromStr
    if _newclass:CreateFromStr = staticmethod(_driver.NeuralNet_CreateFromStr)
...
def NeuralNet_CreateFromStr(*args):
  return _driver.NeuralNet_CreateFromStr(*args)
NeuralNet_CreateFromStr = _driver.NeuralNet_CreateFromStr

class DummyLayer(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, DummyLayer, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, DummyLayer, name)
    __repr__ = _swig_repr
    def Setup(self, *args): return _driver.DummyLayer_Setup(self, *args)
    def Feed(self, *args): return _driver.DummyLayer_Feed(self, *args)
    def ToLayer(self): return _driver.DummyLayer_ToLayer(self)
    def __init__(self): 
        this = _driver.new_DummyLayer()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _driver.delete_DummyLayer
    __del__ = lambda self : None;
DummyLayer_swigregister = _driver.DummyLayer_swigregister
DummyLayer_swigregister(DummyLayer)
...
class Layer(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["CreateLayer"] = lambda x: _driver.Layer_CreateLayer
    if _newclass:CreateLayer = staticmethod(_driver.Layer_CreateLayer)
    __swig_getmethods__["SetupLayer"] = lambda x: _driver.Layer_SetupLayer
    if _newclass:SetupLayer = staticmethod(_driver.Layer_SetupLayer)
    def ComputeFeature(self, *args): return _driver.Layer_ComputeFeature(self, *args)
    def ComputeGradient(self, *args): return _driver.Layer_ComputeGradient(self, *args)
    def data(self, *args): return _driver.Layer_data(self, *args)
    def GetParams(self): return _driver.Layer_GetParams(self)
    def ToString(self, *args): return _driver.Layer_ToString(self, *args)
    def SetParams(self, *args): return _driver.Layer_SetParams(self, *args)
Layer_swigregister = _driver.Layer_swigregister
Layer_swigregister(Layer)

def Layer_CreateLayer(*args):
  return _driver.Layer_CreateLayer(*args)
Layer_CreateLayer = _driver.Layer_CreateLayer

def Layer_SetupLayer(*args):
  return _driver.Layer_SetupLayer(*args)
Layer_SetupLayer = _driver.Layer_SetupLayer

class Updater(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, Updater, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, Updater, name)
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_getmethods__["CreateUpdater"] = lambda x: _driver.Updater_CreateUpdater
    if _newclass:CreateUpdater = staticmethod(_driver.Updater_CreateUpdater)
    def Update(self, *args): return _driver.Updater_Update(self, *args)
Updater_swigregister = _driver.Updater_swigregister
Updater_swigregister(Updater)

def Updater_CreateUpdater(*args):
  return _driver.Updater_CreateUpdater(*args)
Updater_CreateUpdater = _driver.Updater_CreateUpdater
...
class Param(_object):
    ...
    __repr__ = _swig_repr
    def size(self): return _driver.Param_size(self)
    def shape(self): return _driver.Param_shape(self)
    def mutable_cpu_data(self): return _driver.Param_mutable_cpu_data(self)
    def FromProto(self, *args): return _driver.Param_FromProto(self, *args)
    def __init__(self): 
        this = _driver.new_Param()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _driver.delete_Param
    __del__ = lambda self : None;
Param_swigregister = _driver.Param_swigregister
...
class floatBlob(_object):
    ...
    __repr__ = _swig_repr
    def count(self): return _driver.floatBlob_count(self)
    def shape(self): return _driver.floatBlob_shape(self)
    def mutable_cpu_data(self): return _driver.floatBlob_mutable_cpu_data(self)
    def cpu_data(self): return _driver.floatBlob_cpu_data(self)
    def __init__(self): 
